...
fun MainView(){
    ...
    if (isSheetFullScreen) Modifier.fillMaxSize() else Modifier.fillMaxWidth()
    ...
    val title = remember{
        mutableStateOf(Screen.BottomScreen.Home.title)
    }
...
//      To see in the logcat if we get crashes to simply identify the cause
